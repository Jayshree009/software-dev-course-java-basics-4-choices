...
public class CollectionChoiceExercises {
    ...
    public void MakeStudentCollection() {
        ...
        //for lists that can grow or shrink during runtime.
    ...
    public void MakeLoggedInUsersCollection() {
        ...
        //Stores only unique elements and provides fast lookups.
    ...
    public void MakeEmployeeAccessCodesCollection() {
        ...
        //Stores key-value pairs for quick retrieval by key.
        HashMap<String,String> employeeCode = new HashMap<>();
    }
}
